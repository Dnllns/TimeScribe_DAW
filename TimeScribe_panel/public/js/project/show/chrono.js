...
function moveTask(element, statuss) {
    ...
    var workedTime, startDate, finishDate, textColor
    ...
    "<li data-taskid='" + taskId + "'>"+
        "<div class='card m-3'>"+
            ...
            "<div data-name='" + name +"' class='card-header col-12 py-1 px-2 text-uppercase bg-dark " + textColor + "'>"+
                name +
