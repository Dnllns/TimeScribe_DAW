@switch($type)
    ...
    @case('START')
        <i  data-funct="start"
            ...
            class="far fa-play-circle text-success float-right p-2 "
    ...
    @case('VIEW')
        <i  data-funct="view"
            class="far fa-eye text-info float-right p-2"
    ...
    @case('SELECT')
        <i  data-funct="select" data-chronofunct="start"
            class="fas fa-hourglass-start text-warning float-right p-2"
    ...
    @case('DONE')
        <i  data-funct="done"
            ...
            class="far fa-check-circle text-success float-right p-2"
    ...
    @case('DELETE')
        <i  data-funct="delete"
            ...
            class="far fa-trash-alt text-danger float-right py-2"
