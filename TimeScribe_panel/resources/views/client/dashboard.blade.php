                    ...
                    <div id="projectcontent_{{$project->id}}" class="collapse mt-4 p-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                ...
                                <h4 class="text-primary">Task groups</h4>
                                        ...
                                        <div id="task_group_{{$taskGroup->id}}" >
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-10 my-auto">
                                                    <p class="m-0"><strong>{{$taskGroup->name}}</strong></p>
                                                </div>
                                            ...
                                            {{-- TASKGROUP CONTENT --}}
                                            <div data-taskgroup-container="{{$taskGroup->id}}" class="collapse">
                                                ...
                                                <div class="row mt-2">
                                                    ...
                                                    {{-- TODO TASKS --}}
                                                    <div class="col-12 mb-2 collapse" data-colapse="todo_{{$taskGroup->id}}">
