    ...
    <div class="col-12 col-md-12 mx-auto">
        ...
        <div class='row'>
            <div class="col-12 mx-auto">
                <h1 class="display-1">TimeScribe</h1>
                <h2 class="display-4 text-secondary">Control yout time, control your work...</h2>
            </div>
        </div>
        ...
        <div class="row p-3">
            <div class="col-12 col-md-6">
                <img src="/svg/logo_ts.svg" alt="TimeCribe icon" style="height:400px;" >  
            </div>
